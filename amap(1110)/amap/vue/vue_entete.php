...
<head>
    ...
    <link rel="stylesheet" href="vue/css/style4.css">
    ...
    <navbar class="">
        ...
        <div class="boutonnav">
            ...
            if (isset($_SESSION['idAdh']))
            {
                ...
                echo '<a href="index.php?section=panierProduits&action=voirPanier" class="cta"><button class="btnnav">Panier</button></a>';
