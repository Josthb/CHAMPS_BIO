...
<body>
    ...
    <section class="produits">
        ...
        foreach ($lesproduits as $unproduit) {
            ...
            echo "<a href='index.php?section=detailproduit&id=$wIdProduit' class='btn'><i style='font-size : 18px' class='bx bx-search-alt'></i></a><br>";
            
            if (isset($idAdh)) {
                echo "<a href = 'index.php?section=panierProduits&action=ajouterProduit' class='btn'><i style='font-size : 18px' class='bx bx-cart'></i></a>";
            }
